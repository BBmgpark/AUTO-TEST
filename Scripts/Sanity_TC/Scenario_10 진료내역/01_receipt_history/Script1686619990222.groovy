...
'STEP - 가족 {삭제금지} 필터 선택'
Mobile.tap(findTestObject('04_receipt_history/txt_family_filter', [('text') : '삭제금지']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementVisible(findTestObject('04_receipt_history/txt_reception_name', [('text') : '삭제금지']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //자녀
Mobile.verifyElementVisible(findTestObject('04_receipt_history/txt_user_name', [('text') : GlobalVariable.user_name]), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //본인
//

//진료내역 없는 필터 선택 {테스트}
'STEP - 진료대상 [삭제금지] 필터 선택'
Mobile.tap(findTestObject('04_receipt_history/btn_filter', [('text') : '삭제금지']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 진료대상 필터 노출'
Mobile.verifyElementVisible(findTestObject('00_common/txt_class_text_view', [('text'): '진료대상 필터']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'STEP - 가족 {테스트} 필터 선택'
Mobile.tap(findTestObject('04_receipt_history/txt_family_filter', [('text') : '테스트']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'STEP - [확인] 버튼 선택'
Mobile.tap(findTestObject('00_common/txt_class_text_view', [('text'): '확인']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 화면에 "설정하신 필터 내역이 없습니다." 안내문구 노출'
Mobile.verifyElementVisible(findTestObject('04_receipt_history/txt_none_list'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'STEP - [전체내역 보기] 버튼 선택'
Mobile.tap(findTestObject('04_receipt_history/btn_full_history'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 진료대상 필터 "전체대상"으로 변경'
Mobile.verifyElementVisible(findTestObject('04_receipt_history/btn_filter', [('text') : '전체대상']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
//
...
'기대결과 - {삭제금지} 이름 목록 미노출'
Mobile.verifyElementNotVisible(findTestObject('04_receipt_history/txt_reception_name', [('text') : '삭제금지']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
//
...
'기대결과 - 접수하기 화면으로 이동'
Mobile.verifyElementVisible(findTestObject('10_receipt/txt_receipt_title'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //접수하기 {병원명}
...
'기대결과 - 예약하기 화면으로 이동'
Mobile.verifyElementVisible(findTestObject('10_receipt/txt_reservation_title'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //예약하기 {병원명}
...
'기대결과 - 결제정보 노출'
Mobile.verifyElementText(findTestObject('04_receipt_history/txt_detail_methodValue'), '직접결제', FailureHandling.CONTINUE_ON_FAILURE) //진료실명
//
