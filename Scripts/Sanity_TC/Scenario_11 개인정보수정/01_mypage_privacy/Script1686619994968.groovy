...
'기대결과 - 개인정보 확인'
Mobile.verifyElementVisible(findTestObject('05_mypage/txt_description', [('text') : GlobalVariable.user_name]), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //이름
Mobile.verifyElementVisible(findTestObject('05_mypage/txt_description', [('text') : GlobalVariable.hp]), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //휴대폰 번호
Mobile.verifyElementVisible(findTestObject('05_mypage/txt_description', [('text') : GlobalVariable.email_id_22]), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //이메일

'STEP - 휴대폰 번호 선택'
Mobile.tap(findTestObject('05_mypage/txt_description', [('text') : GlobalVariable.hp]), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
'기대결과 - 개인정보 수정 화면으로 이동'
Mobile.verifyElementText(findTestObject('00_common/txt_titleTxt'), '개인정보 수정', FailureHandling.CONTINUE_ON_FAILURE)
Mobile.verifyElementVisible(findTestObject('05_mypage/txt_adress', [('text') : '경기 시흥시 배곧전원로 12-1 (배곧동)  (15010)']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //주소
//
...
'기대결과 - 수정된 주소 노출'
Mobile.verifyElementVisible(findTestObject('05_mypage/txt_adress', [('text') : '경기 부천시 부흥로 49 (상동, 백송마을)  (14591)']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
//

'STEP - [연동하기] 버튼 선택'
Mobile.tap(findTestObject('05_mypage/btn_kakao'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 카카오 계정 로그인 컨테이너 노출 노출'
Mobile.verifyElementVisible(findTestObject('05_mypage/btn_kakao_container'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //카카오톡으로 간편로그인
Mobile.verifyElementVisible(findTestObject('05_mypage/btn_other_container'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //다른 카카오계정으로 로그인

'STEP - [x] 버튼 선택'
Mobile.tap(findTestObject('05_mypage/btn_kakao_container_close'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'STEP - 비밀번호 재설정 선택'
Mobile.tap(findTestObject('05_mypage/txt_password'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 비밀번호 재설정 화면으로 이동'
Mobile.verifyElementVisible(findTestObject('05_mypage/txt_password_title'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //타이틀
...
Mobile.tap(findTestObject('05_mypage/txt_edit_term'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 개인정보 유효기간 변경 화면으로 이동'
Mobile.verifyElementVisible(findTestObject('05_mypage/txt_edit_term_title'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'STEP - [완료] 버튼 선택'
Mobile.tap(findTestObject('00_common/btn_confirmBtn'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 개인정보 수정 화면 노출'
Mobile.verifyElementText(findTestObject('05_mypage/txt_popup_title'), '개인정보 유효기간 변경 완료', FailureHandling.CONTINUE_ON_FAILURE)
