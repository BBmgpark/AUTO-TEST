...
Mobile.verifyElementVisible(findTestObject('11_family/txt_name', [('text') : GlobalVariable.user_name]), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //본인이름
Mobile.verifyElementVisible(findTestObject('11_family/btn_child_add'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //[자녀추가] 버튼
...
'기대결과 - 마이페이지 화면으로 이동'
Mobile.verifyElementVisible(findTestObject('05_mypage/btn_alarm'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)  //알림 버튼
Mobile.verifyElementVisible(findTestObject('05_mypage/btn_setting'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)  //설정 버튼
