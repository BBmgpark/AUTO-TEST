...
Mobile.verifyElementText(findTestObject('10_receipt/txt_choose'), '진료대상 선택', FailureHandling.CONTINUE_ON_FAILURE) //진료대상 선택
...
'STEP - 주민번호 뒷자리 영역 선택'
Mobile.tap(findTestObject('11_family/input_add_ssn_back_number'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
'기대결과 - 접수 완료 화면으로 이동'
Mobile.verifyElementVisible(findTestObject('10_receipt/txt_complete_title'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
