...
if(Mobile.waitForElementPresent(findTestObject('10_receipt/txt_tvName'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE))
{
	Mobile.tap(findTestObject('10_receipt/txt_tvName'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
}
...
//너무 오래걸려서 그냥 현재일 날짜 찍는걸로 대체함 -> 대신 오늘 예약가능한 시간이 필히 있어야함!!
//'예약 가능 날짜가 있는경우 해당 날짜 선택'
//for(i = 1; i <= 31; i++)
//{	
//	if(Mobile.waitForElementPresent(findTestObject('10_receipt/btn_day', [('text') : i]), 2, FailureHandling.CONTINUE_ON_FAILURE) == true)
//	{
//		Mobile.tap(findTestObject('10_receipt/btn_day', [('text') : i]), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
//		if(Mobile.waitForElementPresent(findTestObject('10_receipt/txt_time_select'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) == true)
//		{
//			GlobalVariable.reservation_day = i
//			break
//		}
//	}		
//}
...
//이전 페이지 이동
'STEP - [이전] 버튼 선택'
Mobile.tap(findTestObject('00_common/btn_prevBtn'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 예약 설정 화면으로 이동'
Mobile.verifyElementVisible(findTestObject('10_receipt/txt_description', [('text') : '일반진료']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //진료항목
Mobile.verifyElementVisible(findTestObject('10_receipt/btn_date_time_select'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //[날짜/시간 선택] 버튼
//
...
'기대결과 - 시간 선택 화면으로 이동'
Mobile.verifyElementVisible(findTestObject('10_receipt/txt_time_select'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
//예외 처리 - 간편결제 사용중인 병원의 경우
//'기대결과 - 결제수단 선택 화면으로 이동'
//Mobile.verifyElementText(findTestObject('10_receipt/txt_payment_list_title'), '결제수단 선택', FailureHandling.CONTINUE_ON_FAILURE) //타이틀
//
//'STEP - [병원에서 직접결제] 버튼 선택'
//Mobile.tap(findTestObject('10_receipt/btn_direct'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
//
...
//간편결제 사용여부에 따라 다른 결과값 노출되어 추후 관리
//'STEP - [이전] 버튼 선택'
//Mobile.tap(findTestObject('00_common/btn_prevBtn'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
//
//'기대결과 - 결제수단 선택 화면으로 이동'
...
Mobile.verifyElementText(findTestObject('00_common/txt_titleTxt'), '진료내역 상세', FailureHandling.CONTINUE_ON_FAILURE) //타이틀
...
Mobile.verifyElementVisible(findTestObject('04_receipt_history/btn_detail_reservation_cancel'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //[예약취소] 버튼
...
Mobile.verifyEqual(reservation, GlobalVariable.user_name + '-' + reservation_complete, FailureHandling.CONTINUE_ON_FAILURE)

'STEP - [<-] 이전 버튼 선택'
Mobile.tap(findTestObject('00_common/btn_backBtn'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 홈 화면으로 이동'
Mobile.verifyElementVisible(findTestObject('03_home/btn_menu_home_selected'), 60, FailureHandling.CONTINUE_ON_FAILURE)
