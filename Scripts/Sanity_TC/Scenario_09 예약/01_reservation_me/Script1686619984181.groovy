...
//for(i = 1; i <= 31; i++)
//{	
//	if(Mobile.waitForElementPresent(findTestObject('11_receipt/btn_day', [('text') : i]), 2, FailureHandling.CONTINUE_ON_FAILURE) == true)
//	{
//		Mobile.tap(findTestObject('11_receipt/btn_day', [('text') : i]), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
//		if(Mobile.waitForElementPresent(findTestObject('11_receipt/txt_time_select'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) == true)
//		{
...
//Mobile.verifyElementText(findTestObject('11_receipt/txt_payment_list_title'), '결제수단 선택', FailureHandling.CONTINUE_ON_FAILURE) //타이틀
//
//'STEP - [병원에서 직접결제] 버튼 선택'
//Mobile.tap(findTestObject('11_receipt/btn_direct'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
//
...
Mobile.verifyElementVisible(findTestObject('05_receipt_history/btn_detail_reservation_cancel'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //[예약취소] 버튼
...
'기대결과 - 홈 화면으로 이동'
Mobile.verifyElementVisible(findTestObject('04_home/btn_menu_home_selected'), 60, FailureHandling.CONTINUE_ON_FAILURE)
