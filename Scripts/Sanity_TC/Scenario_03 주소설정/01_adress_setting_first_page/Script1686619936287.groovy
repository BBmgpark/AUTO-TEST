...
//Mobile.tap(findTestObject('01_onboarding/btn_tvEmailLoginBtn'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //[이메일 로그인]
//Mobile.setText(findTestObject('02_login/input_etEmail'), GlobalVariable.email_id_21, GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //이메일 id
//Mobile.setText(findTestObject('02_login/input_etPassword'), GlobalVariable.email_password, GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //이메일 pw
//Mobile.tap(findTestObject('02_login/btn_tvLoginConfirm'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //[로그인]
//
...
//Mobile.verifyElementNotVisible(findTestObject('06_adress_setting/btn_edit'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //[편집]
//Mobile.verifyElementVisible(findTestObject('06_adress_setting/txt_title'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //"어디에 있는 병원을 찾으세요?"
//Mobile.verifyElementVisible(findTestObject('06_adress_setting/btn_current_location'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //[현위치에서 병원 찾기]
//Mobile.verifyElementVisible(findTestObject('06_adress_setting/btn_my_home_find_hospital'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //[우리집 근처 병원 찾기]
...
//Mobile.tap(findTestObject('06_adress_setting/btn_my_home_find_hospital'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
//
//'기대결과 - 주소 검색하기 화면 노출'
//Mobile.verifyElementVisible(findTestObject('00_common/btn_backBtn'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //[뒤로가기]
