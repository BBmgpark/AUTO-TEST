...
'기대결과 - 홈 화면으로 이동'
Mobile.verifyElementVisible(findTestObject('03_home/btn_menu_home_selected'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) // 홈메뉴
...
if (Mobile.waitForElementNotPresent(findTestObject('03_home/02_contents/txt_find_hospital_paediatrics'), GlobalVariable.fixedTime))
{
	'STEP - 화면 스크롤 이동'
...
hospital_name = Mobile.getText(findTestObject('08_search/txt_hospital_name'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'STEP - 병원 목록 선택'
Mobile.tap(findTestObject('08_search/txt_hospital_name'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 병원상세 화면으로 이동'
Mobile.verifyElementText(findTestObject('09_hospital_detail/txt_page_title'), hospital_name, FailureHandling.CONTINUE_ON_FAILURE) //page title
...
Mobile.verifyElementVisible(findTestObject('08_search/btn_filter_general_on'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //selected true
...
if (Mobile.waitForElementNotPresent(findTestObject('03_home/02_contents/img_infant_check-up'), GlobalVariable.fixedTime))
{
	'STEP - 화면 스크롤 이동'
...
if (Mobile.waitForElementNotPresent(findTestObject('03_home/area_rv_recommend_hospital'), GlobalVariable.fixedTime))
{
	'STEP - 화면 스크롤 이동'
