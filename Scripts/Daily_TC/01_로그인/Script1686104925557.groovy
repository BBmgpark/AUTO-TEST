...
if(Mobile.waitForElementPresent(findTestObject('04_home/btn_frame_favorite'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) == false)
{
'최근앱 삭제'
...
if(Mobile.waitForElementPresent(findTestObject('04_home/btn_login'), GlobalVariable.fixedTime) == false)
{
	'STEP- [마이페이지] 메뉴 선택'
...
Mobile.verifyElementVisible(findTestObject('04_home/btn_frame_favorite'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //[찜한목록] 버튼
Mobile.verifyElementNotVisible(findTestObject('04_home/btn_login'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //[시작하기] 버튼 미노출
