...
'검색 결과 첫번째 병원 이름 저장'
hospital_name1 = Mobile.getText(findTestObject('08_search/txt_hospital_name'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementVisible(findTestObject('08_search/btn_all_delete'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //[전체삭제] 버튼
...
'STEP - 검색어 저장'
search_list = Mobile.getText(findTestObject('08_search/input_search'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
hospital_name2 = Mobile.getText(findTestObject('08_search/txt_hospital_name'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
'기대결과 - 검색 화면으로 이동'
Mobile.verifyElementText(findTestObject('08_search/input_search'), search_list, FailureHandling.CONTINUE_ON_FAILURE) //검색 인풋 

'STEP - [x] 검색어 삭제 버튼 선택'
Mobile.tap(findTestObject('08_search/btn_search_clear'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 검색어 삭제되고, 최근 검색어 노출'
Mobile.verifyElementText(findTestObject('08_search/txt_recent_list'), search_list, FailureHandling.CONTINUE_ON_FAILURE) //검색어
...
'검색 결과 첫번째 병원 이름 저장'
hospital_name3 = Mobile.getText(findTestObject('08_search/txt_hospital_name'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementVisible(findTestObject('08_search/area_hospital_map_list'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //바텀시트 영역
Mobile.verifyElementVisible(findTestObject('08_search/txt_map_hospital_name', [('text') : hospital_name3]), GlobalVariable.fixedTime) //검색 목록 첫번째 병원이름
