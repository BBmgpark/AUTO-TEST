...
if(Mobile.waitForElementPresent(findTestObject('10_receipt/txt_name', [('text') : GlobalVariable.son]), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) == false)
{
'STEP - [자녀추가] 버튼 선택'
Mobile.tap(findTestObject('10_receipt/btn_add_child'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
'STEP - 진료대상 가족 선택'
Mobile.tap(findTestObject('10_receipt/txt_name', [('text') : GlobalVariable.son]), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementVisible(findTestObject('10_receipt/txt_transmission_title'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //타이틀
...
if(Mobile.waitForElementPresent(findTestObject('10_receipt/txt_family_Noti'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) == true)
{
	Mobile.tap(findTestObject('00_common/btn_confirmBtn'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
}
...
'기대결과 - 자녀 접수 카드 노출'
Mobile.verifyElementText(findTestObject('03_home/txt_tvHospitalTitle'), GlobalVariable.hospital_name, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementVisible(findTestObject('10_receipt/txt_name', [('text') : GlobalVariable.son]), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //이름
...
Mobile.verifyElementVisible(findTestObject('04_receipt_history/btn_detail_reservation_cancel'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
