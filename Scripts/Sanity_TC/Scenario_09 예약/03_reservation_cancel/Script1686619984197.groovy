...
'기대결과 - 진료내역 화면으로 이동'
Mobile.verifyElementVisible(findTestObject('04_receipt_history/txt_title'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
Mobile.verifyElementText(findTestObject('04_receipt_history/txt_hospital_name'), GlobalVariable.hospital_name, FailureHandling.CONTINUE_ON_FAILURE) //병원명
Mobile.verifyElementText(findTestObject('04_receipt_history/txt__deny_reason'), '본인 요청으로 예약이 취소되었어요.', FailureHandling.CONTINUE_ON_FAILURE) //취소사유
...
Mobile.tap(findTestObject('11_family/txt_name_list', [('text') : '아들']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //아들 선택
...
Mobile.tap(findTestObject('03_home/btn_menu_home'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //홈 메뉴
